...
//Route Barang
Route::get('/add', [CRUD::class, 'create'])->middleware(['auth', 'can:view-petugas-dashboard,view-admin-dashboard', 'verified']);
...
Route::get('/edit/{id}', [CRUD::class, 'edit'])->middleware(['auth', 'can:view-petugas-dashboard,view-admin-dashboard', 'verified']);
Route::get('/delete/{id}', [CRUD::class, 'destroy'])->middleware(['auth', 'can:view-petugas-dashboard,view-admin-dashboard', 'verified']);
...
//route pdf
Route::get('/export-pdf', [HistoryController::class, 'exportPDF'])->middleware(['auth', 'can:view-petugas-dashboard,view-admin-dashboard', 'verified']);
