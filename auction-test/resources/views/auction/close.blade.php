    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form id="my-form" action="/close" method="post">
                    ...
                    @foreach ($listHistory as $item)
                        ...
                        {{-- <label for="item-name">Item Name:</label> --}}
                        <input type="hidden" id="item-id" name="item-id" value="{{ $item->id_barang }}" readonly>
                        ...
                        <label for="item-name">Item Name:</label>
                        <input type="text" id="item-name" name="item-name" value="{{ $item->barang->nama_barang }}" readonly>
                        <span style="color : red">
                            @error('item-id')
                                {{ $message }}
                            @enderror
                        ...
                        <input type="text" id="auctioneer" name="auctioneer" value="{{ $item->barang->auctioneer }}"
                            readonly>
                        <span style="color : red">
                            @error('auctioneer')
                                {{ $message }}
                        ...
                        <input type="date" id="date" name="date" value="{{ $item->tanggal_lelang }}"
                            readonly>
                        <span style="color : red">
                            @error('date')
                                {{ $message }}
                        ...
                        <input type="submit" value="CLOSE BID" onclick="return confirm('Are you sure you want to close the bid?')">
                    @endforeach
                </form>
            </div>
        </div>
