        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="/updateLelang" method="post">
                    ...
                    <label for="bid">Current Highest Bid: @money($Info->harga_akhir) || Bidder:
                        {{ $Info->user_name }}</label>
                    ...
                    <input type="hidden" readonly id="auctioneer" name="auctioneer" value="{{ $Info->barang->auctioneer }}">
                    <span style="color : red">
                        @error('auctioneer')
                            {{ $message }}
                        @enderror
